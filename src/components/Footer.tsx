        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm opacity-80">
              ...
              <li><button onClick={() => document.getElementById("research")?.scrollIntoView({ behavior: "smooth" })} className="hover:text-accent transition-colors">Focus Areas</button></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm opacity-80">
              <li><a href="mailto:foundationwadhwaniiitk@gmail.com" className="hover:text-accent transition-colors">foundationwadhwaniiitk@gmail.com</a></li>
              <li className="hover:text-accent transition-colors cursor-pointer">0512-6794051 / 0512-6794052</li>
            </ul>
          </div>
        </div>
